---
layout: post
title: "Everything has an API. So can we connect everything?"
slug: "api-tutorial"
category: blog
author: kevin
date: 2018-07-12 09:00:00
excerpt: "I’m a typical developer (I think).. I love writing and designing code. But writing about writing code, well not so much. So to motivate myself to write this post I decided to set myself a coding challenge."
graphic: /img/api-tutorial/wordcloud.png
---

<div class="text-align: center">
    <img src="/img/api-tutorial/wordcloud.png" alt="" class="img-responsive"
...
After trying out a few Speech Recognition tools I signed up to <a href="https://cloud.google.com/">Google Cloud Platform</a> which gives me €300 free credit. Perfect! Google’s Cloud platform is a suite of AI/ big data/ analytics/ infrastructure tools for basically everything. For my sample data I grabbed one of OnePageCRM’s Youtube videos and extracted out a .flac file from it. After following <a href="https://cloud.google.com/speech-to-text/docs/quickstart-gcloud">this </a> quickstart guide.
I could then convert an audio file to text using just one line of code/ request to Google! <a href="https://www.youtube.com/watch?v=VIQAHfY4VwY">Here</a> is the video I sampled from (It’s our GDPR webinar, you should watch it!) and this was the output

<div class="text-align: center">
    <img src="/img/api-tutorial/speech_result.png" alt="" class="img-responsive"
...
In OnePageCRM, we use basic auth to authenticate requests. To get your username and password for basic auth you can simply log in to your OnePageCRM account and navigate to apps page and select API and navigate to the configuration tab. See <a href="https://developer.onepagecrm.com/">here</a> for more information as well as full documentation on our API. 
...
<a href="https://app.onepagecrm.com/api/v3/contacts/5b322ca19007ba2289b3c931/notes.json">https://app.onepagecrm.com/api/v3/contacts/5b322ca19007ba2289b3c931/notes.json</a> 
In typical restful fashion, a `GET` request will display all our notes for this contact while a `POST` request will create a new note. All CRUD operations are supported. Notice that in this request I have hard coded in the contact id. You can find Jane Doe’s id by making a `GET` request to the contacts endpoint.

Here is the contents of a shell file that automates this entire process from audio file to Note in OnePageCRM which I have saved as `speech_to_onepagecrm.sh`. Note that I am using CURL here but you could use your prefered way of interaction with web services or even one of our client libraries.
...
<div class="text-align: center">
    <img src="/img/api-tutorial/note_sample.png" alt="" class="img-responsive"
     style="width: 75%; position: relative" /><br />
</div>
...
<div class="text-align: center">
    <img src="/img/api-tutorial/ocr_result.png" alt="" class="img-responsive"
     style="width: 75%; position: relative" /><br />
</div>
...
<div class="text-align: center">
    <img src="/img/api-tutorial/ocr_sh.png" alt="" class="img-responsive"
     style="width: 100%; position: relative" /><br />
</div>    
