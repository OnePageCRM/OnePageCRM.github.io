...
<table class="table table-striped table-bordered">
  ...
  <tbody>
    <tr>
      ...
      <td><code class="bluetext">login.format</code></td>
      <td>Create a new tag</td>
    </tr>
    <tr>
      <td class="get-text strong">GET</td>
      <td><code class="bluetext">bootstrap.format</code></td>
...
<table class="table table-striped table-bordered">
  ...
  <tbody>
    <tr>
      ...
      <td><code class="bluetext">login</code></td>
      <td>Email address of user logging in</td>
    </tr>
    <tr>
      <td class="nowrap"><code class="redtext">string</code></td>
      <td class="nowrap"><code class="bluetext">password</code></td>
...
<tbody>
  <tr>
    <td class="nowrap"><code class="redtext">string</code></td>
  <td><code class="bluetext">auth_key</code></td>
  <td>This is a base64 encoded string that you must use to sign
    further api requests.</td>
  </tr>
  <tr>
    <td><code class="redtext">string</code></td>
    <td><code class="bluetext">user_id</code></td>
    <td>ID of the user</td>
  </tr>
  <tr>
    <td><code class="redtext">string</code></td>
    <td><code class="bluetext">account_type</code></td>
  ...
  <tr>
    ...
    <tr>
      <td><code class="redtext">array</code></td>
      <td><code class="bluetext">filters</code></td>
      <td>User’s list of custom filters</td>
    </tr>
    <tr>
      <td><code class="redtext">object</code></td>
      <td><code class="bluetext">user</code></td>
    ...
    <tr>
      <td><code class="redtext">object</code></td>
      <td><code class="bluetext">settings</code></td>
...
<table class="table table-striped table-bordered">
  ...
  <tbody>
    <tr>
      ...
      <td><code class="bluetext">statuses</code></td>
    ...
    <tr>
      <td><code class="redtext">array</code></td>
      <td class="nowrap"><code class="bluetext">lead_sources</code></td>
      <td>List of lead sources for the user’s account</td>
    </tr>
    <tr>
      <td><code class="redtext">hash</code></td>
      <td><code class="bluetext">team_stream</code></td>
      <td>
        ...
        <table class="table table-striped table-bordered">
          ...
          <tbody>
            <tr>
              <td class="nowrap"><code class="redtext">array</code></td>
              <td class="nowrap"><code class="bluetext">users</code></td>
              <td>
                Every item is a <span class="redtext">hash</span> with 2 elements:
                <table class="table table-striped table-bordered">
                  <thead>
            ...
            <tr>
              <td><code class="redtext">int</code></td>
              <td><code class="bluetext">all</code></td>
    ...
    <tr>
      <td><code class="redtext">hash</code></td>
      <td class="nowrap"><code class="bluetext">contacts_count</code></td>
      <td>
        This returns the number of total number of contacts, for each user and for the whole team, arranged by how many contacts have a last name beginning with each letter of the alphabet. Every item is a <span class="redtext">hash</span> with 2 elements:
        <table class="table table-striped table-bordered">
          <thead>
            <tr>
              <td>Type</td>
          ...
          <tbody>
            <tr>
              ...
              <td class="nowrap"><code class="bluetext">users</code></td>
              <td>
                Every item is a <span class="redtext">hash</span> with 28 elements:
                <table class="table table-striped table-bordered">
                  <thead>
                    <tr>
                      <td>Type</td>
            ...
            <tr>
              ...
              <td><code class="bluetext">all</code></td>
              <td>
                Every item is a <span class="redtext">hash</span> with 27 elements:
                <table class="table table-striped table-bordered">
                  <thead>
                    <tr>
                      <td>Type</td>
    ...
    <tr>
      <td><code class="redtext">hash</code></td>
      <td><code class="bluetext">sales</code></td>
      <td>
        Every item is a <span class="redtext">hash</span> with 4 elements:
        <table class="table table-striped table-bordered">
          <thead>
            <tr>
              <td>Type</td>
...
<table class="table table-striped table-bordered">
  ...
  <tbody>
    <tr>
      ...
      <td><code class="bluetext">logout.format</code></td>
...
<table class="table table-striped table-bordered">
  ...
  <tbody>
    <tr>
      <td class="get-text">GET</td>
      <td><code class="bluetext">change_auth_key.format</code></td>
